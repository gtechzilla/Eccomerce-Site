...
<?php
	...
	if(isset($_POST['insert_now'])){
		...
		$insert_product="insert into products(product_cat,product_title,product_price,product_image,product_keywords) values('$product_category','$product_title','$product_price','$product_image','$product_keywords')";
